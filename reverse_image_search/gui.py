...
class ImageSimilarityGUI:
    def __init__(self):
        ...
        self.plot_button = tk.Button(self.root, text="Plot Images", command=self.plot_images)
    ...
    def plot_images(self):
        ...
        similar_images, similarities = self.image_similarity.find_similar_images2(image_path, k=num_images)
