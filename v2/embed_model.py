...
class EfficientNetEmbeddingFunction(EmbeddingFunction[Documents]):
    ...
    def load_image(self, image: str | Path | Image.Image | np.ndarray):
        ...
        # print('piexel: ',inputs['pixel_values'].shape)
        # print('type: ',type(inputs['pixel_values']))
    ...
    def batch_embed_images(self, images: list[str | Path | Image.Image], batch_size: int = 32):
        """
    ...
    def __call__(self, images: list[Image.Image | Path | str], batch_size: int = 32) -> Embeddings:
